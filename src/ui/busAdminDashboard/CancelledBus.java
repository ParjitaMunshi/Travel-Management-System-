 ...
 * @author slenk
 */
public class CancelledBus extends javax.swing.JPanel {

    /**
     * Creates new form CancelledBus
     */
    ...
    public CancelledBus(BusAdminDashboard b) {
        initComponents();
        bb = b;
        populateTable();
    }
...
//        int personId = MySQLUtil.getPersonSession().getId();
        String query = "select * from bus_bookings bb, bus b where booking_status = 'CANCELED'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cancelled Buses");
