...
//    }
	...
	categoryNameArr[i] = categoryList.get(i).getCategoryName();
        ...
        String[] arr = {"Travel Insurance"};
        
        categoryDropdown.setModel(new javax.swing.DefaultComboBoxModel<>(arr));
    }
    ...
    private void CreatePolicyBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreatePolicyBtnActionPerformed
        ...
        MySQLUtil.addpolicydetails(PolicyName,"Travel Insurance",PolicySumAssurance,PolicyPremium,PolicyTenure,PolicyDate);
